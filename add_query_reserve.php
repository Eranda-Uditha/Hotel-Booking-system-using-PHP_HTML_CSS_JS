<?php
	...
	if(ISSET($_POST['add_guest'])){
		...
		$days = (($checkout2-$checkin1)/(60*60*24) )+ 1 ;
		$extra = $_POST['extra'];
				...
				if($row > 0){
					echo "<div class = 'col-md-4'>
						...
						if($guest_id = $fetch['guest_id']){
							...
							$conn->query("INSERT INTO `transaction`(guest_id, room_id, status, checkin,extra,days) VALUES('$guest_id', '$room_id', 'Pending', '$checkin','$extra','$days')") or die(mysqli_error());
