...
<html>
    ...
    <body>
		...
		<div class = "panel panel-default">
			<div class = "panel-body" style="background-image: url('image/hotel2.webp'); background-size:cover;">
				<br />
                    <?php 
			...
			<div class = "panel panel-danger" style="border: 2px solid #9e9a9a4f;">
                ...
                <div style = "height:300px; width:800px;">
					<div style = "float:left;">
						<img src = "photo/<?php echo $fetch['photo']?>" height = "300px" width = "346px">
					</div>
                ...
                <form method = "POST" enctype = "multipart/form-data">
						...
						<div class = "form-group">
							...
							<input type = "date" class = "form-control" name = "date2" required = "required" />
						</div>
						<!-- <div class = "form-group" >
						<label>Days</label>
						<br />
					...
					<div class = "form-group" >
						...
						<br />
						<input type = "number" min = "0" max = "99" name = "extra" class = "form-control"/>
					</div>
