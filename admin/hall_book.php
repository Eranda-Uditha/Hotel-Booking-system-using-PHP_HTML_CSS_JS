...
<body style = "background-color:rgba(235 170 240 / 15%);">
	...
	<div class = "container-fluid">
        ...
        <?php
            ...
            <a class = "btn  btn-success " ><span class = "badge"><?php echo $f_p['total']?></span> Pending</a>
				<a class = "btn btn-success" href = "hall_bookread.php"><span class = "badge"><?php echo $f_ci['total']?></span> Check in</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php  
							$query = $conn->query("SELECT * FROM `hall_book` WHERE `status` = 'Pending'") or die(mysqli_error());
						...
						<tr>
							...
							<td><center><a class = "btn btn-success" href = "read_hall_book.php?id=<?php echo $fetch['id']?>"> Check in</a> <a class = "btn btn-success" onclick = "confirmationDelete(this); return false;" href = "message_delete.php?id=<?php echo $fetch['id']?>"> Delete</a></center></td>
						</tr>
						<?php
							}
						?>
