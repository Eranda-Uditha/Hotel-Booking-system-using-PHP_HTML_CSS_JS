...
<body style = "background-color:rgba(235 170 240 / 15%);">
	<nav style = "background-color:rgba(8 7 7 / 17%);" class = "navbar navbar-default">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><center><a class = "btn btn-success" href = "edit_account.php?admin_id=<?php echo $fetch['admin_id']?>"> Edit</a> <a class = "btn btn-success" onclick = "confirmationDelete(this); return false;" href = "delete_account.php?admin_id=<?php echo $fetch['admin_id']?>"> Delete</a></center></td>
						</tr>
						<?php
							}
						?>
