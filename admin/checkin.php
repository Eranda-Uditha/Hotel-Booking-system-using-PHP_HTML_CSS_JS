	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<a class = "btn btn-success"><span class = "badge"><?php echo $f_ci['total']?></span> Check In</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo date("M d, Y", strtotime($fetch['checkin']."+".$fetch['days']."DAYS"))."</label>"?></td>
							<td><?php echo $fetch['status']?></td>
							<td><?php if($fetch['extra'] == "0"){ echo "None";}else{echo $fetch['extra'];}?></td>
							<td><?php echo "Rs. ".$fetch['bill'].".00"?></td>
							<td><center><a class = "btn btn-success" href = "checkout_query.php?transaction_id=<?php echo $fetch['transaction_id']?>" onclick = "confirmationCheckin(); return false;"> Check Out</a></center></td>
						</tr>
						<?php
							}
						?>
